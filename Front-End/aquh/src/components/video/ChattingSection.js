...
// export default class ChattingSection extends Component {
//     // 로그인 대신
// let roomNum = null;
...
//           <div className={containerFluidChatSection} id="chat-box">
//           </div>
...
//                                 <button id="chat-send" className={msgSendNtn} type="button"><i className={fa fa-paper-plane}
